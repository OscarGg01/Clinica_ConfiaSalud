...
<body>
    ...
    <div class="relleno-especialidades">
      <div class="contenido">
          <h1 class="titulo-citas">ESPECIALIDADES</h1>
          <p>Esta es una sección de relleno para mostrar cómo se vería el contenido adicional en la página.</p>
      </div>
  </div>  
