...
<body>
  ...
  {{-- ------------------ HISTORIAL ------------------ --}}
  <div class="relleno_historial py-5">
    <div class="container py-5">
        <h2 class="mb-4 text-center">Accede a tu historial de citas</h2>
      
        @if(session('error'))
          <div class="alert alert-danger">{{ session('error') }}</div>
        @endif
      
        <form method="POST" action="{{ route('citas.historial.verificar') }}" class="mx-auto" style="max-width: 400px;">
          @csrf
          <div class="mb-3">
