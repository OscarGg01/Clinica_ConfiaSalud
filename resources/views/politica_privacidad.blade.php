...
<body>
  ...
  <div class="container py-5">
    <h1 class="mb-4" style="color: #024744; font-weight: 700;">Política de Privacidad</h1>
    ...
    <ul>
      <li>Nombre, DNI, fecha de nacimiento</li>
      <li>Correo electrónico y teléfono</li>
      <li>Datos relacionados con tus citas médicas</li>
    </ul>

    <h3>3. Finalidad</h3>
    <p>Gestionar reservas de citas, envío de confirmaciones y recordatorios, y brindar atención personalizada.</p>

    <h3>4. Legitimación</h3>
    <p>Consentimiento del interesado (checkbox en el formulario) y cumplimiento de obligaciones contractuales.</p>

    <h3>5. Destinatarios</h3>
    <p>Tus datos no se cederán a terceros, salvo requerimiento legal.</p>

    <h3>6. Plazo de conservación</h3>
    <p>Mientras mantengas relación con la clínica y durante los plazos legales posteriores.</p>

    <h3>7. Derechos ARCO</h3>
    <p>Puedes solicitar Acceso, Rectificación, Cancelación u Oposición escribiendo a <a href="mailto:privacy@confiasalud.com">privacy@confiasalud.com</a>.</p>

    <h3>8. Cambios en la política</h3>
    <p>Nos reservamos el derecho a actualizar esta política. Fecha de última actualización: <strong>{{ now()->format('d/m/Y') }}</strong>.</p>
  </div>
